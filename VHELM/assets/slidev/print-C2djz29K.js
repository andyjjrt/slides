import{d as _,aj as u,z as f,f as n,g as t,t as s,C as c,F as h,af as g,o as l,i as v,e as x,a9 as b}from"../modules/vue-j41QyVbg.js";import{a as y,u as N,y as m}from"../index-BiU4ZQ3P.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-BI6ULyRx.js";import"../modules/shiki-C01_B2YW.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},j={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(z){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
